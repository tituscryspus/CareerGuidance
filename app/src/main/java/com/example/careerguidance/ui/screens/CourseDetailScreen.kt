...
fun CourseDetailScreen(
    ...
    if (showPdfViewer) {
        val pdfUri = Uri.parse("android.resource://${context.packageName}/${course.pdfResId}")
        PdfViewerScreen(
            pdfUri = pdfUri,
            title = "${course.name} Requirements",
            onBackPressed = { showPdfViewer = false }
        )
    } else {
        Scaffold(
            topBar = {
